...
pub contract WeaponItems: NonFungibleToken {
    ...
    pub resource interface WeaponItemsCollectionPublic {
        ...
        pub fun borrowWeaponItem(id: UInt64): &WeaponItems.NFT? {
    ...
    pub resource Collection: WeaponItemsCollectionPublic, NonFungibleToken.Provider, NonFungibleToken.Receiver, NonFungibleToken.CollectionPublic, MetadataViews.ResolverCollection {
        ...
        //
        pub fun deposit(token: @NonFungibleToken.NFT) {
            let token <- token as! @WeaponItems.NFT
        ...
        pub fun borrowViewResolver(id: UInt64): &AnyResource{MetadataViews.Resolver} {
            ...
            let weaponItem = nft as! &WeaponItems.NFT
    ...
    pub resource NFTMinter: NFTMinterPublic {
        ...
        pub fun mintNFT(
            ...
            recipient.deposit(token: <-create WeaponItems.NFT(id: WeaponItems.totalSupply, name: name, attack: attack, defence: defence, url: url))

            emit Minted(
                id: WeaponItems.totalSupply,
                name: name,
                attack: attack,
                defence: defence,
                url: url
            ...
            WeaponItems.totalSupply = WeaponItems.totalSupply + (1 as UInt64)
        }
    }
    ...
    //
    pub fun fetch(_ from: Address, itemID: UInt64): &WeaponItems.NFT? {
        let collection = getAccount(from)
            .getCapability(WeaponItems.CollectionPublicPath)!
            .borrow<&WeaponItems.Collection{WeaponItems.WeaponItemsCollectionPublic}>()
