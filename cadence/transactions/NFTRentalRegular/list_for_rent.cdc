...
transaction(tokenId: UInt64, endTime: UFix64, rentPerDay: UFix64, rentTokenType: String, guarantee: UFix64) {
  ...
  execute {
    ...
    NFTRentalRegular.listForRent(acct: self.signer, tokenId: tokenId, endTime: endTime, rentPerDay: rentPerDay, rentTokenType: rentTokenType, guaranteePayment: <- vault)
  }
}